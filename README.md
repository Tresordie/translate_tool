...
- **6 主题一键切换** — 海洋/清新/暗黑/浅色/暖橙/樱花，右下角悬浮按钮自由切换，鲜亮清爽配色 + 玻璃拟态质感
- **精致质感界面** — SVG 噪点背景、三层环境光晕、玻璃卡片顶部光泽、多层景深阴影、发丝渐变边框、星星背景动效，网页版与插件视觉统一
- **打字机效果** — 翻译结果逐字显示，体验流畅
...
- **6 主题切换** — 与网页版共享 theme.css 主题系统，鲜亮清爽配色 + 玻璃拟态质感
...
├── theme.css               # 共享主题系统（6 主题变量 + 玻璃卡片/噪点/环境光等公共样式）
...
- **右键菜单翻译** — 选中文字后右键选择「LinguaFlow 翻译」
- **6 主题与质感 UI** — 与网页版共享主题系统，鲜亮清爽配色、玻璃拟态卡片、噪点背景与景深阴影
