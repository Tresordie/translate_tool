...
- **6 主题一键切换** — 青瓷/玄墨/月白/陶土/绯樱/静谧海，每个主题一个独立色彩世界（色相染色中性色 + 冷暖对撞副强调色），右下角悬浮按钮自由切换，玻璃拟态质感
- **精致质感界面** — SVG 噪点背景、三层环境光晕、玻璃卡片顶部光泽、多层景深阴影（随色相染色）、发丝渐变边框、按钮按压反馈、骨架屏等待态，网页版与插件视觉统一
- **打字机效果** — 翻译结果逐字显示，体验流畅
